...
def page(title=None, pageid=None, auto_suggest=True, redirect=True, preload=False, sm=False):
  '''
  ...
  * preload - load content, summary, images, references, and links during initialization
  ...
  if title is not None:
    ...
    return WikipediaPage(title, redirect=redirect, preload=preload, smoo=sm)
  elif pageid is not None:
    return WikipediaPage(pageid=pageid, preload=preload, smoo=sm)
  else:
...
class WikipediaPage(object):
  ...
  def __init__(self,title=None, pageid=None, redirect=True, preload=False, smoo = True, original_title=''):
    self.smoo = smoo
    if title is not None:
      self.title = title
  ...
  def __load(self, redirect=True, preload=False):
    ...
    ##===BEGGIN ADDING=== OFTAV##
    elif (('pageprops' in page)&(self.smoo)):
      query_params = {
        'prop': 'revisions',
        'rvprop': 'content',
        'rvparse': '',
      ...
      self.refs = [li.a.get_text() for li in filtered_lis if li.a]
      self.urls = [li.a.get('href') for li in filtered_lis if li.a]
    ##===END ADDING=== OFTAV##
